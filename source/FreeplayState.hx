...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Thinking of the past", null);
		#end
		...
		scoreText.setFormat(Paths.font("the Gingerbread House"), 32, FlxColor.WHITE, RIGHT);

		scoreBG = new FlxSprite(scoreText.x - 6, 0).makeGraphic(1, 66, 0xFF000000);
		scoreBG.alpha = 0.6;
		add(scoreBG);

		diffText = new FlxText(FlxG.width * 0.7, 5, 0, "", 32);
		diffText.setFormat(Paths.font("Gingerbread House.ttf"), 36, FlxColor.WHITE, RIGHT);
		add(diffText);
		...
		text.setFormat(Paths.font("Gingerbread House.ttf"), size, FlxColor.WHITE, RIGHT);
	...
	function changeSelection(change:Int = 0, playSound:Bool = true)
	{
		...
		Lib.application.window.title = "Friday Night Insomnia - freeplay - " + songs[curSelected].songName;
	}
