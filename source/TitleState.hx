...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		Lib.application.window.title = "Friday Night Insomnia - Title";
	}
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Night Dont', 15);
					addMoreText('let', 15);
					#else
					addMoreText('WRONG PLACE HIIIIII');
					#end
				// credTextShit.text += '\npresent...';
				// credTextShit.addText();
				case 5:
					addMoreText('The DEMONS', 15);
					addMoreText('BITE',15);
					case 6:
					deleteCoolText();
				// credTextShit.visible = false;l
				// credTextShit.text = 'In association \nwith';
				// credTextShit.screenCenter();
				case 7:
					#if PSYCH_WATERMARKS
					createCoolText(['fall', 'into'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 8:
					addMoreText('insanity', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Insomnia'); // credTextShit.text += '\nFunkin';
				case 17:
					deleteCoolText();
				case 18:
					addMoreText('Dreams');
