...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	public static var fg:FlxSprite;
	public static var statreal:FlxSprite;
	...
	public function new()
	{
		...
		descText.setFormat(Paths.font("Gingerbread House.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
