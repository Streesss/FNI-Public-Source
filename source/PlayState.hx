...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("Gingerbread House.ttf"), 38, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		Lib.application.window.title = "Friday Night Insomnia - " + SONG.song + " - (" + storyDifficultyText + ")";
	...
	private function generateSong(dataPath:String):Void
	{
		...
		Lib.application.window.title = "Friday Night Insomnia - " + curSong;
	...
	override function closeSubState()
	{
		if (paused)
		{
			...
			if (startTimer != null && startTimer.finished)
			{
				DiscordClient.changePresence(detailsText, SONG.song + " misses - " + songMisses + " (" + storyDifficultyText + ")", iconP2.getCharacter(), true, songLength - Conductor.songPosition - ClientPrefs.noteOffset);
